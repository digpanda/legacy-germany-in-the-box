class WechatApi::JsConfig < BaseService
  ...
  private
    ...
    def signature_gateway
      @signature_gateway ||= WechatApi::Signature.new(request: request, ticket: ticket, nonce_str: nonce_str, timestamp: timestamp).resolve
    end
