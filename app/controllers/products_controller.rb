...
=end
  ...
  private
    ...
    def product_params
      ...
      params.require(:product).permit(:desc, :name, :brand, :img, :duty_category, :data, category_ids:[], tags:[], options_attributes: [:id, :name, suboptions_attributes: [:id, :name]], skus_attributes: [:id, :img0, :img1, :img2, :img3, :price, :discount, :quantity, :weight, :customizable, :status, :unit, :space_length, :space_width, :space_height, :time, :data, option_ids: []]).delocalize(delocalize_config)
    end
end
