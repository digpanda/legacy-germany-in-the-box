...
class Guest::ReferrersController < ApplicationController
  ...
  def qrcode
    send_data Flyer.new.process_qrcode(qrcode_path).image.to_blob, stream: 'false', filename: 'qrcode.jpg', type: 'image/jpeg', disposition: 'attachment' #disposition: 'inline'
  end
