...
class ShopApplicationController < ApplicationController
  ...
  def shop_application_params
    params.require(:shop_application).permit(:email, :name, :desc, :philosophy, :stories, :founding_year, :register, :website, :statement0, :statement1,  :statement2, :fname, :lname, :tel, :mobile, :mail, :german_essence, :uniqueness)
  end
