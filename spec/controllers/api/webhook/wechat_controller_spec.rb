...
def wechat_valid_qrcode_scan_params(referrer)
  {"ToUserName"=>"FAKE_VALID_USERNAME", "FromUserName"=>"FAKE_VALID_FROMUSERNAME", "CreateTime"=>"1501489767", "MsgType"=>"event", "Event"=>"SCAN", "EventKey"=>"{\"referrer\":{\"reference_id\":\"#{referrer.reference_id}\"}}", "Ticket"=>"gQH18DwAAAAAAAAAAS5odHRwOi8vd2VpeGluLnFxLmNvbS9xLzAyUDNiRDF4R29ibC0xMDAwMDAwN04AAgR_jHhZAwQAAAAA"}
end
