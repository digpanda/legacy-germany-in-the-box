...
CMD_RESTORE="mongorestore -h $STAGING_DB_HOST --port $STAGING_DB_PORT -u $STAGING_DB_USER -p $STAGING_DB_PASSWORD --authenticationDatabase $STAGING_DB_NAME --db $STAGING_DB_NAME --drop $PROD_BACKUP_DIR_DB"
