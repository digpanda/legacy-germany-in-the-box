...
concern :shared_orders do
  ...
  match :checkout_success,          via: [:post, :get],         action: :checkout_success,        as: :checkout_success,            :on => :collection
  match :checkout_fail,             via: [:post, :get],         action: :checkout_fail,           as: :checkout_fail,               :on => :collection
