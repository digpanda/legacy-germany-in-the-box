::CarrierWave.configure do |config|
  ...
  config.qiniu_bucket         = Rails.env.production? ? 'carrierwave-laiyinn-prod' : 'carrierwave-laiyinn-dev'
  config.qiniu_bucket_domain  = Rails.env.production? ? '7xt4mc.com1.z0.glb.clouddn.com' : 'o6n7omia8.bkt.clouddn.com'
